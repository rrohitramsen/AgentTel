...
graph TB
    ...
    style IDE fill:#818cf8,stroke:#6366f1,color:#1e1b4b
    style AGT fill:#818cf8,stroke:#6366f1,color:#1e1b4b
    style INS fill:#818cf8,stroke:#6366f1,color:#1e1b4b
    style APP fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style WEB fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style CORE fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style WEBSDK fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
...
graph LR
    ...
    style R fill:#818cf8,stroke:#6366f1,color:#1e1b4b
...
flowchart TD
    ...
    style A fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style B fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style C fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style D fill:#818cf8,stroke:#6366f1,color:#1e1b4b
    style E fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
...
flowchart TD
    ...
    style A fill:#818cf8,stroke:#6366f1,color:#1e1b4b
    style B fill:#818cf8,stroke:#6366f1,color:#1e1b4b
    style C fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style D fill:#818cf8,stroke:#a5b4fc,color:#1e1b4b
...
flowchart TD
    ...
    style B fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style C fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style D fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style E fill:#818cf8,stroke:#6366f1,color:#1e1b4b
    style F fill:#818cf8,stroke:#a5b4fc,color:#1e1b4b
```
...
flowchart LR
    ...
    style Browser fill:#a78bfa,stroke:#7c3aed,color:#1e1b4b
    style Backend fill:#818cf8,stroke:#6366f1,color:#1e1b4b
